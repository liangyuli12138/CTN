...
#================================================================================
write.table(mean_expression_noshuffle,file="/public/workspace/lily/CTN/version_3_20/metabolism/Tcell/KEGGpathway_activity_noshuffle.txt",row.names=T,col.names=T,quote=F,sep="\t")
write.table(mean_expression_shuffle,file="/public/workspace/lily/CTN/version_3_20/metabolism/Tcell/KEGGpathway_activity_shuffle.txt",row.names=T,col.names=T,quote=F,sep="\t")
write.table(pvalues_mat,file="/public/workspace/lily/CTN/version_3_20/metabolism/Tcell/KEGGpathway_activity_shuffle_pvalue.txt",row.names=T,col.names=T,quote=F,sep="\t")
